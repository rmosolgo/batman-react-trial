...
Batman.View.store.set('/animals/index', '<div class=\"row\"><h1>All Animals<small data-bind=\"Animal.loaded.length | append &quot;)&quot; | prepend &quot; (&quot;\"></small></h1></div><ul class=\"list-unstyled\"><li data-foreach-animal=\"Animal.all\"><div class=\"row\"><div class=\"col-xs-3\"><p data-bind=\"animal.name\" class=\"lead\"></p></div><div class=\"col-xs-2\"><button data-event-click=\"controllers.animals.executeAction | withArguments &quot;edit&quot;, animal\" class=\"btn\">Edit in Dialog</button></div><div class=\"col-xs-2\"><button data-event-click=\"destroyAnimal | withArguments animal\" class=\"btn btn-danger\">Destroy</button></div></div></li></ul><p class=\"row\"><div class=\"well\"><form data-formfor-animal=\"newAnimal\" data-event-submit=\"saveAnimal | withArguments newAnimal\"><div class=\"form-group\"><label>New Animal:</label><input type=\"text\" data-bind=\"animal.name\" class=\"form-control\"/></div><input type=\"submit\" value=\"Save\" class=\"btn btn-primary\"/></form></div></p>');