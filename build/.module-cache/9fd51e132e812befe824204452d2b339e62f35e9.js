      ...
      React.DOM.div(null, 
        ...
        React.DOM.div( {className:"modal-body"}, 
          React.DOM.form( {onSubmit:this.handleWith("save", this.sourceKeypath('currentAnimal'))}, 
            ...
            React.DOM.div( {className:"form-group"}, 
              React.DOM.select( {class:"form-control", value:this.sourceKeypath("currentAnimal.color"), onChange:this.updateKeypath("currentAnimal.color")}, 
                this.enumerate("currentAnimal.constructor.COLORS", 'color', function(c){
