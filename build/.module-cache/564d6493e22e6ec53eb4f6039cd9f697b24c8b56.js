...
App.AnimalsEditComponent = React.createClass({displayName: 'AnimalsEditComponent',
  ...
  updateKeypath: function (keypath) {
    ...
    return function(e) {
      ...
      var k = new Batman.Keypath(ctx, keypath)
      var lastProperty = k.terminalProperty()
      lastProperty.setValue(e.target.value)
    }
  },
  sourceKeypath: function(keypath) {
    return this._lookupKeypath(keypath)
  },
  ...
  _lookupKeypath: function(keypath) {
