          ...
          React.DOM.form( {onSubmit:this.handleWith("save", this.sourceKeypath('currentAnimal'))}, 
            ...
            React.DOM.div( {className:"form-group"}, 
              React.DOM.label( {className:"radio-inline"}, 
                "Mammal",
                React.DOM.input( {type:"radio", value:"Mammal", checked:this.sourceKeypath('currentAnimal.animalClass'), onChange:this.updateKeypath('currentAnimal.animalClass')} )
              ),
              React.DOM.label( {className:"radio-inline"}, 
                "Fish",
                React.DOM.input( {type:"radio", value:"Fish",  checked:this.sourceKeypath('currentAnimal.animalClass'), onChange:this.updateKeypath('currentAnimal.animalClass')} )
              )
            ),
