          ...
          React.DOM.form( {onSubmit:this.handleWith("save", this.sourceKeypath('currentAnimal'))}, 
            ...
            React.DOM.div( {className:"radio"}, 
              React.DOM.label( {className:"radio-inline"}, 
                "Mammal",
                React.DOM.input( {type:"radio", value:"Mammal", onChange:this.updateKeypath('currentAnimal.animalClass')} )
              ),
              React.DOM.label( {className:"radio-inline"}, 
                "Fish",
                React.DOM.input( {type:"radio", value:"Fish", onChange:this.updateKeypath('currentAnimal.animalClass')} )
              )
            ),
