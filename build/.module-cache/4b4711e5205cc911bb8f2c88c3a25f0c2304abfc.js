  ...
  render: function(){
    var animals = this.enumerate("animals", "animal", function(animal) {
              ...
              if (this.sourceKeypath('animal.extinct')) {
                extinct = (React.DOM.span( {className:"text-muted"}, 
                  "(extinct)"
                ))
              }
            return (
                ...
                React.DOM.div( {className:"row"}, 
                  React.DOM.div( {className:"col-xs-3"}, 
                    React.DOM.p( {className:"lead"}, 
                      this.sourceKeypath('animal.name'),
                      extinct
                    )
                  ),
        ...
        React.DOM.div( {className:"modal-body"}, 
          React.DOM.form( {onSubmit:this.handleWith("save", this.sourceKeypath('currentAnimal'))}, 
            ...
            React.DOM.div( {className:"form-group"}, 
              ...
              React.DOM.input( {type:"checkbox", className:"form-control", checked:this.sourceKeypath("currentAnimal.extinct"), onChange:this.updateKeypath('currentAnimal.extinct')})
            ),
